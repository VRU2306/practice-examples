...
export default function LoginPage() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen py-1">
            ...
            <button
                onClick={onLogin}
                className="p-2 sm:w-48 md:w-96 border border-gray-300 rounded-lg mb-4 focus:outline-none focus:border-gray-600 disabled:cursor-not-allowed" disabled={buttonDisabled}>Login</button>
